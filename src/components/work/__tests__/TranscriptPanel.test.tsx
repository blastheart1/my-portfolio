...
describe('height never depends on content', () => {
  it('fixes the scroll region rather than capping it', () => {
    ...
    // max-h would let the panel shrink for short notes, which is the bug.
    expect(region.className).not.toMatch(/\bmax-h-/);
  });
